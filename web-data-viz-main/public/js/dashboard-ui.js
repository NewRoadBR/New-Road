(function () {
  ...
  function initInteractions() {
    ...
    if (refreshBtn && typeof iniciarDashboard === "function") {
      refreshBtn.addEventListener("click", function () {
        var icon = refreshBtn.querySelector("i");
        if (icon) icon.classList.add("spinning");
        iniciarDashboard().finally(function () {
          if (icon) icon.classList.remove("spinning");
        });
      });
    }

    document.querySelectorAll("[data-chart-filter]").forEach(function (btn) {
      btn.addEventListener("click", function () {
        document.querySelectorAll("[data-chart-filter]").forEach(function (b) {
